...
# Set bspwm configuration for showno
set_bspwm_config() {
...
# (Rose-Pine Moon) Color scheme for showno Rice
...
launch_bars() {
	...
	for mon in $(polybar --list-monitors | cut -d":" -f1); do
		MONITOR=$mon polybar -q showno-bar -c "${rice_dir}"/config.ini &
	done
